  ...
  var e = {
    ...
    952: (e, r, n) => {
      ...
      SourceMapConsumer.prototype.eachMapping = function SourceMapConsumer_eachMapping(e, r, n) {
        ...
        a.map(function (e) {
          ...
          return {source: r, generatedLine: e.generatedLine, generatedColumn: e.generatedColumn, originalLine: e.originalLine, originalColumn: e.originalColumn, name: e.name === null ? null : this._names.at(e.name)};
        }, this).forEach(e, t);
      };
        ...
        if (a >= 0) {
          ...
          if (e.column === undefined) {
            ...
            while (u && u.originalLine === s) {
              t.push({line: o.getArg(u, 'generatedLine', null), column: o.getArg(u, 'generatedColumn', null), lastColumn: o.getArg(u, 'lastGeneratedColumn', null)});
      ...
      BasicSourceMapConsumer.prototype.originalPositionFor = function SourceMapConsumer_originalPositionFor(e) {
        ...
        if (n >= 0) {
          ...
          if (t.generatedLine === r.generatedLine) {
            ...
            return {source: i, line: o.getArg(t, 'originalLine', null), column: o.getArg(t, 'originalColumn', null), name: a};
          }
        }
      ...
      BasicSourceMapConsumer.prototype.generatedPositionFor = function SourceMapConsumer_generatedPositionFor(e) {
        ...
        if (t >= 0) {
          ...
          if (i.source === n.source) {
            return {line: o.getArg(i, 'generatedLine', null), column: o.getArg(i, 'generatedColumn', null), lastColumn: o.getArg(i, 'lastGeneratedColumn', null)};
          }
        }
        return {line: null, column: null, lastColumn: null};
      };
      ...
      function IndexedSourceMapConsumer(e, r) {
        ...
        this._sections = i.map(function (e) {
          ...
          u = n;
          return {generatedOffset: {generatedLine: t + 1, generatedColumn: i + 1}, consumer: new SourceMapConsumer(o.getArg(e, 'map'), r)};
        });
      }
      ...
      IndexedSourceMapConsumer.prototype.generatedPositionFor = function IndexedSourceMapConsumer_generatedPositionFor(e) {
        for (var r = 0; r < this._sections.length; r++) {
          ...
          if (t) {
            var i = {line: t.line + (n.generatedOffset.generatedLine - 1), column: t.column + (n.generatedOffset.generatedLine === t.line ? n.generatedOffset.generatedColumn - 1 : 0)};
            return i;
          }
        }
    ...
    591: (e, r, n) => {
      ...
      SourceMapGenerator.prototype.addMapping = function SourceMapGenerator_addMapping(e) {
        ...
        this._mappings.add({generatedLine: r.line, generatedColumn: r.column, originalLine: n != null && n.line, originalColumn: n != null && n.column, source: t, name: i});
      };
      ...
      SourceMapGenerator.prototype._validateMapping = function SourceMapGenerator_validateMapping(e, r, n, t) {
        ...
        if (e && 'line' in e && 'column' in e && e.line > 0 && e.column >= 0 && !r && !n && !t) {
          ...
          throw new Error('Invalid mapping: ' + JSON.stringify({generated: e, source: n, original: r, name: t}));
        }
      };
        ...
        this.walk(function (e, o) {
          ...
          if (o.source !== null && o.line !== null && o.column !== null) {
            if (i !== o.source || a !== o.line || s !== o.column || l !== o.name) {
              n.addMapping({source: o.source, original: {line: o.line, column: o.column}, generated: {line: r.line, column: r.column}, name: o.name});
            }
            i = o.source;
            a = o.line;
            s = o.column;
